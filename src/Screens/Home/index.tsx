...
const HomeScreen = () => {
    ...
    const BlogCard = memo(({ item }: any) => (
        <View style={{ backgroundColor: COLORS.secondary[50], borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: COLORS.primary[200] }}>
            ...
            <View style={{ padding: 14, gap: 8 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('PostDetails', { id: item._id })} style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4, justifyContent: 'flex-end' }}>
