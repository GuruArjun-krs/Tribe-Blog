...
import { Platform, StatusBar, StyleSheet, View, ViewStyle, Dimensions } from 'react-native';
...
const SelectDropdownComp = ({ options, placeholder = 'Select', onSelect, value, buttonStyle, search }: SelectDropdownProps) => {
    ...
    return (
        <SelectDropdown
            ...
            searchPlaceHolderColor='#828692'
            search={search}
            onSelect={onSelect}
            renderButton={(selectedItem, isOpened) => {
                return (
                    <View style={[styles.dropdownButtonStyle, buttonStyle]}>
                        <Typo numberOfLines={1} ellipsizeMode='tail' style={{ fontSize: 14, color: COLORS.text[400] }} title={selectedItem?.title || placeholder} />
